...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="DIGITAL_IO" URI="http://resources/4.0.16/app/DIGITAL_IO/1" description="The DIGITAL_IO APP is used to configure &#xA; a port pin as digital Input/Output." mode="NOTSHARABLE" version="4.0.16" minDaveVersion="4.0.0" instanceLabel="LED1" appLabel="">
  ...
  <hwResources name="pin" URI="http://resources/4.0.16/app/DIGITAL_IO/1/hwres_port_pin" resourceGroupUri="port/p/sv0/pad/*" solverVariable="true" mResGrpUri="port/p/sv0/pad/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../../../../../xmc1100_freertos_spi_master/Dave/Model/HW_RESOURCES/Port1/Port1_1.dd#//@provided.6"/>
  ...
  <hwResources name="pin" URI="http://resources/4.0.16/app/DIGITAL_IO/1/__pin_hwres_port_pin" resourceGroupUri="devicepackage/0/13" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../../../../../xmc1100_freertos_spi_master/Dave/Model/HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.3"/>
  </hwResources>
