...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="SPI_SLAVE" URI="http://resources/4.0.8/app/SPI_SLAVE/0" description="Configures a USIC channel to implement SPI slave functionality" mode="NOTSHARABLE" version="4.0.8" minDaveVersion="4.1.2" instanceLabel="SPI_SLAVE_0" appLabel="">
  ...
  <virtualSignals name="event_transmit_buffer" URI="http://resources/4.0.8/app/SPI_SLAVE/0/vs_spi_sl_std_tx_int" hwSignal="transmit_buffer_int" hwResource="//@hwResources.0" required="false"/>
  <virtualSignals name="event_receive_start" URI="http://resources/4.0.8/app/SPI_SLAVE/0/vs_spi_sl_rec_start_int" hwSignal="receive_start_int" hwResource="//@hwResources.0" required="false"/>
  <virtualSignals name="event_std_receive" URI="http://resources/4.0.8/app/SPI_SLAVE/0/vs_spi_sl_std_rx_int" hwSignal="standard_receive_int" hwResource="//@hwResources.0" required="false"/>
  <virtualSignals name="event_alt_receive" URI="http://resources/4.0.8/app/SPI_SLAVE/0/vs_spi_sl_alt_rx_int" hwSignal="alternate_receive_int" hwResource="//@hwResources.0" required="false"/>
  ...
  <virtualSignals name="event_fifo_transmit" URI="http://resources/4.0.8/app/SPI_SLAVE/0/vs_spi_sl_fifo_tx_int" hwSignal="standard_transmit_buffer_int" hwResource="//@hwResources.0"/>
  <virtualSignals name="event_fifo_std_receive" URI="http://resources/4.0.8/app/SPI_SLAVE/0/vs_spi_sl_fifo_rx_int" hwSignal="standard_receive_buffer_int" hwResource="//@hwResources.0"/>
  <virtualSignals name="event_fifo_alt_receive" URI="http://resources/4.0.8/app/SPI_SLAVE/0/vs_spi_sl_fifo_alt_rx_int" hwSignal="alternate_receive_buffer_int" hwResource="//@hwResources.0"/>
  <virtualSignals name="sr_transmit" URI="http://resources/4.0.8/app/SPI_SLAVE/0/vs_interrupt_spi_sl_tx" hwSignal="signal_in" hwResource="//@hwResources.7"/>
  <virtualSignals name="sr_receive" URI="http://resources/4.0.8/app/SPI_SLAVE/0/vs_interrupt_spi_sl_rx" hwSignal="signal_in" hwResource="//@hwResources.8"/>
  ...
  <requiredApps URI="http://resources/4.0.8/app/SPI_SLAVE/0/appres_cpu" requiredAppName="CPU_CTRL_XMC1" requiringMode="SHARABLE">
  ...
  <hwResources name="DMA channel Rx" URI="http://resources/4.0.8/app/SPI_SLAVE/0/hwres_dma_ch_rx" resourceGroupUri="" required="false" solverVariable="true" mResGrpUri="peripheral/sv0/0/ch/*">
    <solverVarMap index="1">
      <value variableName="sv0" solverValue=""/>
    </solverVarMap>
    <solverVarMap index="1">
