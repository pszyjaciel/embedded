...
task. h 
\begin{DoxyPre}void \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2task_8h_a366b302eba79d10b5ee2a3756f0fcc43}{vTaskSuspendAll( void )}};\end{DoxyPre}
...
A\+PI functions that have the potential to cause a context switch (for example, \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2task_8h_a067da3e949e248096ec6c01f9cb75a47}{v\+Task\+Delay\+Until()}}, \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2queue_8h_af7eb49d3249351176992950d9185abe9}{x\+Queue\+Send()}}, etc.) must not be called while the scheduler is suspended.
