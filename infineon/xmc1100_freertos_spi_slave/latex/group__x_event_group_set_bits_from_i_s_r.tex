...
\begin{center}
\leavevmode
\includegraphics[width=326pt]{group__x_event_group_set_bits_from_i_s_r}
\end{center}
\end{figure}
event\+\_\+groups.\+h 
\begin{DoxyPre}
   BaseType\_t \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2event__groups_8h_a62b68278abac6358369ae8e390988a02}{xEventGroupSetBitsFromISR( EventGroupHandle\_t xEventGroup, const EventBits\_t uxBitsToSet, BaseType\_t *pxHigherPriorityTaskWoken )}};
\end{DoxyPre}


A version of \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2event__groups_8h_a02d7b3bb55f7e11d9c47116266c5fb2e}{x\+Event\+Group\+Set\+Bits()}} that can be called from an interrupt.

Setting bits in an event group is not a deterministic operation because there are an unknown number of tasks that may be waiting for the bit or bits being set. Free\+R\+T\+OS does not allow nondeterministic operations to be performed in interrupts or from critical sections. Therefore \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2event__groups_8h_a62b68278abac6358369ae8e390988a02}{x\+Event\+Group\+Set\+Bits\+From\+I\+S\+R()}} sends a message to the timer task to have the set operation performed in the context of the timer task -\/ where a scheduler lock is used in place of a critical section.
...
\begin{DoxyPre}  // An event group which it is assumed has already been created by a call to
  // \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2event__groups_8c_a2e8622ce280fff2f60ad867dff0a4519}{xEventGroupCreate()}}.
...
\begin{DoxyPre}    // Was the message posted successfully?
    ...
    \{
        ...
        // will be either \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2portable_2_g_c_c_2portmacro_8h_aac6850c66595efdc02a8bbb95fb4648e}{portYIELD\_FROM\_ISR()}} or \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2portable_2_g_c_c_2portmacro_8h_a63b994040c62c9685490a71c87a13d8a}{portEND\_SWITCHING\_ISR()}} -\/
        // refer to the documentation page for the port being used.
        \mbox{\hyperlink{_keil_2_a_r_m___c_m4_f_2portmacro__mpu_8h_aac6850c66595efdc02a8bbb95fb4648e}{portYIELD\_FROM\_ISR( xHigherPriorityTaskWoken )}};
    \}
 \}
  \end{DoxyPre}
