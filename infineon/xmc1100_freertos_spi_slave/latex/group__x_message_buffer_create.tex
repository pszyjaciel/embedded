...
\begin{DoxyPre}
MessageBufferHandle\_t \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2message__buffer_8h_a2959cd0e3d2bd20d46908e5c9872be36}{xMessageBufferCreate( size\_t xBufferSizeBytes )}};
\end{DoxyPre}


Creates a new message buffer using dynamically allocated memory. See \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2message__buffer_8h_acc84f4a15dbd39ecbad35f7337e78b2c}{x\+Message\+Buffer\+Create\+Static()}} for a version that uses statically allocated memory (memory that is allocated at compile time).

config\+S\+U\+P\+P\+O\+R\+T\+\_\+\+D\+Y\+N\+A\+M\+I\+C\+\_\+\+A\+L\+L\+O\+C\+A\+T\+I\+ON must be set to 1 or left undefined in \mbox{\hyperlink{_free_r_t_o_s_config_8h}{Free\+R\+T\+O\+S\+Config.\+h}} for \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2message__buffer_8h_a2959cd0e3d2bd20d46908e5c9872be36}{x\+Message\+Buffer\+Create()}} to be available.
...
\begin{DoxyPre}    // Create a message buffer that can hold 100 bytes.  The memory used to hold
    ...
    xMessageBuffer = \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2message__buffer_8h_a2959cd0e3d2bd20d46908e5c9872be36}{xMessageBufferCreate( xMessageBufferSizeBytes )}};\end{DoxyPre}
