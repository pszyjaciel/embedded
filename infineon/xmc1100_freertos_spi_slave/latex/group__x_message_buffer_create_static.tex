...
\end{DoxyPre}
 Creates a new message buffer using statically allocated memory. See \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2message__buffer_8h_a2959cd0e3d2bd20d46908e5c9872be36}{x\+Message\+Buffer\+Create()}} for a version that uses dynamically allocated memory.
