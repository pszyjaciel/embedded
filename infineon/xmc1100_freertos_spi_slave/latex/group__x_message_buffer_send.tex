...
{\em xTicksToWait} & The maximum amount of time the calling task should remain
   ...
   \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2message__buffer_8h_a858f6da6fe24a226c45caf1634ea1605}{xMessageBufferSend()}} is called.  The calling task will never block if
   xTicksToWait is zero.  The block time is specified in tick periods, so the
   absolute time it represents is dependent on the tick frequency.  The macro
   \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2projdefs_8h_a353d0f62b82a402cb3db63706c81ec3f}{pdMS\_TO\_TICKS()}} can be used to convert a time specified in milliseconds into
...
The number of bytes written to the message buffer.  If the call to
   \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2message__buffer_8h_a858f6da6fe24a226c45caf1634ea1605}{xMessageBufferSend()}} times out before there was enough space to write the
...
\begin{DoxyPre}    if( xBytesSent != sizeof( ucArrayToSend ) )
    \{
        // The call to \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2message__buffer_8h_a858f6da6fe24a226c45caf1634ea1605}{xMessageBufferSend()}} times out before there was enough
