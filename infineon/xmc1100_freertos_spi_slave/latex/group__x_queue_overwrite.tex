...
\mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2queue_8h_a8e9ced123b5a0e37a36d3bbdb2e56b4e}{x\+Queue\+Overwrite()}} is a macro that calls \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2queue_8h_a7ce86d1026e0c3055a523935bf53c0b3}{x\+Queue\+Generic\+Send()}}, and therefore has the same return values as \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2queue_8h_aa612fcc2b1ceee0200f34b942e300b41}{x\+Queue\+Send\+To\+Front()}}. However, pd\+P\+A\+SS is the only value that can be returned because \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2queue_8h_a8e9ced123b5a0e37a36d3bbdb2e56b4e}{x\+Queue\+Overwrite()}} will write to the queue even when the queue is already full.
\end{DoxyReturn}
Example usage\+: 
...
\begin{DoxyPre}    // Create a queue to hold one uint32\_t value.  It is strongly
    // recommended *not* to use \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2queue_8h_a8e9ced123b5a0e37a36d3bbdb2e56b4e}{xQueueOverwrite()}} on queues that can
...
\begin{DoxyPre}    // Write the value 10 to the queue using \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2queue_8h_a8e9ced123b5a0e37a36d3bbdb2e56b4e}{xQueueOverwrite()}}.
    ulVarToSend = 10;
    \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2queue_8h_a8e9ced123b5a0e37a36d3bbdb2e56b4e}{xQueueOverwrite( xQueue, \&ulVarToSend )}};\end{DoxyPre}
...
\begin{DoxyPre}    // The queue is still full.  Use \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2queue_8h_a8e9ced123b5a0e37a36d3bbdb2e56b4e}{xQueueOverwrite()}} to overwrite the
