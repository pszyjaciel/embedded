...
Successfully received items remain on the queue so will be returned again by the next call, or a call to \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2queue_8h_ae8364d988c6f9b63c771cc2b3dfe5df9}{x\+Queue\+Receive()}}.

This macro must not be used in an interrupt service routine. See \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2queue_8h_ac402adf98be1fb8ca0345f30dc11a9dc}{x\+Queue\+Peek\+From\+I\+S\+R()}} for an alternative that can be called from an interrupt service routine.
