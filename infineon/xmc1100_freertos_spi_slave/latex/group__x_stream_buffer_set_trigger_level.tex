...
\begin{DoxyPre}
BaseType\_t \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2stream__buffer_8h_a28f0280587c76e71efeaa8f415ebde04}{xStreamBufferSetTriggerLevel( StreamBufferHandle\_t xStreamBuffer, size\_t xTriggerLevel )}};
\end{DoxyPre}
...
A trigger level is set when the stream buffer is created, and can be modified using \mbox{\hyperlink{_generated_2_f_r_e_e_r_t_o_s_2stream__buffer_8h_a28f0280587c76e71efeaa8f415ebde04}{x\+Stream\+Buffer\+Set\+Trigger\+Level()}}.
