...
;********************************************************************************************************
                ...
                .extern  BSP_ADC_ISR_Handler  ; C part of the ADC handler interrupt
#endif
...
;                                           ADC ISR
;
; Description : This function is the ADC ISR that is triggered when the AD converter has finished a conversion.
;
;               The following C-like pseudo-code describe the operation being performed in the code below.
;
;               Save all registers on the current task's stack:
...
BSP_ADC_ISR_1:
                CALL    BSP_ADC_ISR_Handler         ; Call INT4 ISR Handler written in C
