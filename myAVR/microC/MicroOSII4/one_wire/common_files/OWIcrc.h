...
unsigned char OWI_ComputeCRC8(uint8_t inData, uint8_t seed);
unsigned int OWI_ComputeCRC16(uint8_t inData, uint16_t seed);
unsigned char OWI_CheckRomCRC(uint8_t * romValue);
