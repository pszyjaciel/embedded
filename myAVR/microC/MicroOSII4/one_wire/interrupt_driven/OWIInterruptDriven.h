...
#if OWI_UART_2X==0
#define     OWI_UBRR_115200     F_CPU/(16L*115200L)-1
#else
#define     OWI_UBRR_115200     F_CPU/(8L*115200L)-1
#endif
...
#if OWI_UART_2X==0
#define     OWI_UBRR_9600     F_CPU/(16L*9600L)-1
#else
#define     OWI_UBRR_9600     F_CPU/(8L*9600L)-1
#endif
